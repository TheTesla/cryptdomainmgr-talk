...
\begin{frame}[fragile]{\insertsection}{\insertsubsection} % fragile: no indentation allowed
	\textbf{domain configuration details}
	\begin{verbatim}
	~/cryptdomainmgr$ cat example.conf
...
\begin{frame}[fragile]{\insertsection}{\insertsubsection} % fragile: no indentation allowed
	\textbf{domain configuration -- same for SRV}
	\begin{verbatim}
	~/cryptdomainmgr$ cat example.conf
...
\begin{frame}[fragile]{\insertsection}{\insertsubsection} % fragile: no indentation allowed
	\textbf{domain configuration -- DMARC update!}
	\begin{verbatim}
	~/cryptdomainmgr$ cat example.conf
...
\begin{frame}[fragile]{\insertsection}{\insertsubsection} % fragile: no indentation allowed
	\textbf{domain configuration -- SOA update!}
	\begin{verbatim}
	~/cryptdomainmgr$ cat example.conf
...
\begin{frame}[fragile]{\insertsection}{\insertsubsection} % fragile: no indentation allowed
	\textbf{domain configuration -- SPF update!}
	\begin{verbatim}
	~/cryptdomainmgr$ cat example.conf
	...
	\begin{itemize}
		...
		\item "`atomic"' operation
		\item at most one \texttt{SPF} record in allowed!
	\end{itemize}
\end{frame}	

\begin{frame}[fragile]{\insertsection}{\insertsubsection} % fragile: no indentation allowed
	\textbf{domain configuration -- ADSP and CAA records}
	\begin{verbatim}
	~/cryptdomainmgr$ cat example.conf
