...
\begin{document}
	...
	\subsection{TLSA}
	\begin{frame}{\insertsection}{\insertsubsection}
		\textbf{DANE -- DNS-based Authentication of Named Entities}\\		\includegraphics[height=3cm]{TLSA.pdf}\\
	...
	\subsection{CAA}
	\begin{frame}{\insertsection}{\insertsubsection}
		\includegraphics[height=4cm]{CAA.pdf}\\
...
\begin{frame}[fragile]{\insertsection}{\insertsubsection} % fragile: no indentation allowed
	...
	signingConfTemplateFile
	  = ~/cryptdomainmgr/dkim_signing_template.conf
	signingConfTemporaryFile
	  = /etc/rspamd/dkim_signing_new.conf
